...
export default function Product() {
  ...
  useEffect(() => {
    ...
    const data = {
      ...
      minPrice,
      maxPrice,
      // minDiscount: parseInt(discount, 10) || 0,
  ...
  console.log("productchuiachuiwhuihdata", products);
  return (
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                              ...
                              {section.options.map((option, optionIdx) => (
                                <div key={option.value} className="flex items-center">
                                  <input
                                    ...
                                    defaultValue={option.value}
                                    type="checkbox"
                                    defaultChecked={categoryFilter.includes(option.value)}
                                    className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                  />
                                  <label
                            ...
                            <div className="space-y-4">
                              <FormControl>
                                ...
                                >
                                  {section.options.map((option, optionIdx) => (
                                    <>
                                      <FormControlLabel onChange={(e) => handleRadioFilterChange(e, section.id)} className="text-gray-600" value={option.value} control={<Radio />} label={option.label} />
                                    </>
                                  ))}
                                </RadioGroup>
                              </FormControl>
              ...
              <div className="lg:col-span-4">
                <div className='flex flex-wrap justify-center bg-white'>
                  {/* {tilesdata.map((item) => <ProductCard product={item} />)} */}
