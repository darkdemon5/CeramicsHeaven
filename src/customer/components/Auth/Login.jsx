  ...
  const onSubmit = async (data, event) => {
    try {
      ...
      if (response.data.message === "SignIn Successfull") {
        ...
        swal("Success", "Sign In Successful", "success").then(() => {
          navigate("/");
        });
      ...
      if (error.response) {
        ...
        swal("Login Failed", error.response.data.message || "Server Error", "error");
      } else if (error.request) {
        // The request was made but no response was received
        console.error("Network Error:", error.request);
        swal("Login Failed", "Network Error. Please try again later.", "error");
      } else {
        // Something else happened in making the request
        console.error("Error:", error.message);
        swal("Login Failed", "An unexpected error occurred. Please try again later.", "error");
      }
    }
  };
