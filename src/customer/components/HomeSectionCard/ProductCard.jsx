        ...
        <div className='cursor-pointer flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden w-[15rem] mx-3'>
            <div className="border border-gray-200 rounded-md bg-gray-50 dark:border-gray-900 rounded-b-md dark:bg-gray-900">
                <div className="relative " >
                    <img src={product.imageUrl} alt="" className="object-cover w-full mx-auto h-[15rem] lg:h-[15rem]" />
                ...
                <div className="p-6 ">
                    <div className="mb-3">
                        ...
                        <p className='mt-2' href="#">{product.title}</p>
                    </div>
                    <p className="text-lg font-medium text-gray-600 dark:text-gray-400">
                        <span className='font-semibold m-1'>₹{product.discountPrice}</span>
                        <span className='line-through opacity-50 m-1'>{product.price}</span>
                        <span className='text-green-600 font-semibold m-1'>{product.discountPercent}% off</span>
                    </p>
                </div>
            </div>
        </div>
